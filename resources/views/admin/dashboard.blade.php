          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="index.html">
                ...
                <span class="menu-title">All Atudent</span>
              </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="layoutsSubmenu">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="pages/layout/boxed-layout.html">Regestation Fee</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/layout/rtl-layout.html">Tution Fee</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/layout/horizontal-menu.html">Result</a>
                  </li>
                </ul>
              </div>
            </li>
              ...
              <div class="collapse" id="sidebar_layouts">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                   ...
                   <li class="nav-item">
                    <a class="nav-link" href="pages/layout/sidebar-hidden.html">LLB</a>
                  </li>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="pages/layout/sidebar-hidden-overlay.html">Economics</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/layout/sidebar-fixed.html">English</a>
                  </li>
                </ul>
              </div>
            </li>
